...
%\usepackage[width=151mm,height=211mm,center,noinfo]{crop} % bez lini cięcia, konsultuj z dokumentacją
...
\input{EDI_Block_Wysocki/editorial.tex}
...
\input{ART_Israel/Israel.tex}
\input{ART_Linsbichler/Linsbichler.tex}
\input{ART_Dominiak/Dominiak.tex}
\input{ART_Cordoba/Oliva.tex}
\input{ART_Machaj/Machaj.tex}
\input{ART_McGee/McGee.tex}
\input{ART_Turowski/lachmann.tex}
\input{ART_Ceglarska/Ceglarska.tex}
\input{ART_Wysocki_etal/Wysocki_etal.tex}
\input{ART_Posvanc/Posvanc.tex}
\input{ART_Slenzok/Slenzok.tex}
\input{ART_Megger/Megger.tex}
\input{ART_Nowakowski/Nowakowski.tex}
...
\input{DIS_Wysocki/Wysocki.tex}
\input{DIS_Block/Block.tex}

%
\sekcja{Review essays}{Artykuły recenzyjne}
\input{REV_Czyzniewski/Czyzniewski.tex}
