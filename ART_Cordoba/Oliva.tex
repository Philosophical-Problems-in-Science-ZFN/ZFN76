\begin{artengenv}{Michael Oliva Córdoba}
...
%\label{ref:RNDL2rsHFWOjq}(cf. Minio-Paluello, 1961, 5:22; Aristotle, 1938, )
...
%
%\noindent (Subjectivity)
%
%
%
%\noindent (i)\ \qquad \textit{p} ${\nvdash}$ $\Delta $\textit{\textsubscript{x}} \textit{p}
%
%
%
%\noindent (ii) \qquad $\Delta $\textit{\textsubscript{x}} \textit{p} ${\nvdash}$ \textit{p}
%
%\medskip
...
\begin{description}[font=\normalfont, labelindent=0pt, leftmargin=!, labelwidth=1cm]
  \item[(Individuality)]
  \item[(i)] \textit{p} ${\nvdash}$ $\Delta_{\textit{x}}$ \textit{p}
  \item[(ii)] $\Delta_{\textit{y}}$ \textit{p} ${\nvdash}$ \textit{p}
\end{description}
...
%\label{ref:RNDYd59Ns4Wnw}(see, e.g., Burton-Roberts, 2016, p.46; Tallerman, 2015, p.34; Lewis, 1970, p.20ff; Lyons, 1968, p.147; Ajdukiewicz, 1935, p.3; Husserl, 1913, p.242; all anticipated by Frege, 1891; Engl. transl. 1960, p.189; and Plato, 1921 ).
...
\vspace{-.09cm}
\begin{description}[font=\normalfont, labelindent=0pt, leftmargin=!, labelwidth=1cm]
  \item[(TD)] \textit{$\varphi $xy} \& \textit{$\psi $yx} because W\textit{\textsubscript{x}} \textit{$\psi $yx} \& W\textit{\textsubscript{y}} \textit{$\varphi $xy} \& B\textit{\textsubscript{x}} (\textit{$\varphi $xy} $to$ \textit{$\psi $yx}) \& B\textit{\textsubscript{y}} (\textit{$\psi $yx} $to$ \textit{$\varphi $xy})
\end{description}
\vspace{-.09cm}
...
\vspace{-.09cm}
\begin{description}[font=\normalfont, labelindent=0pt, leftmargin=!, labelwidth=1cm]
  \item[(AR)] \textls[-20]{\textit{$\gamma $y} because W\textit{\textsubscript{y}} ((TD) \& ¬ (TH)) \& B\textit{\textsubscript{y}} \textit{$\gamma $y} $\to$ ((TD) \& ¬ (TH))
  \&
